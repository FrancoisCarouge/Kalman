...
//! @brief Compile-time sized Eigen3 matrix, row-major.
//!
//! @details Facade for Eigen3 implementation compatibility. The row-major
//! memory order variation allows for showing the library does not depend on
//! matrices' storage order. It helps in evaluating potential performance
//! differences.
//!
