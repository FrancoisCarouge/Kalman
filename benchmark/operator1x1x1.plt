...
set title "{/:Bold Function Call Operator 1x1x1 Float Benchmark}\n{/*0.8 kalman<float, float, float>::operator()}"
set output "operator1x1x1.svg"
set key noautotitle
...
set yrange [46 : 54]
set ytics .5
set xtics ("Operator() 1x1x1 Float" 0)

plot "/tmp/operator1x1x1.csv" using (0):6 with boxes linecolor rgb "#F7DC6F" title "Maximum", \
