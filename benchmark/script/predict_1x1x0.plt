...
set output "kalman/benchmark/image/predict_1x1x0.svg"
set key noautotitle
...
plot "/tmp/kalman/kalman_benchmark_predict_1x1x0.csv" using (0):6 with boxes linecolor rgb "#F7DC6F" title "Maximum", \
