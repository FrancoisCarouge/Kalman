...
set title "{/:Bold Function Call Operator 1x1x0 Float Benchmark}\n{/*0.8 kalman<float, float, void>::operator()}"
set output "operator1x1x0.svg"
set key noautotitle
...
set yrange [40 : 66]
set ytics 1
set xtics ("Operator() 1x1x0 Float" 0)

plot "/tmp/operator1x1x0.csv" using (0):6 with boxes linecolor rgb "#F7DC6F" title "Maximum", \
