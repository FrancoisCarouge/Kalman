...
[[nodiscard("The returned process noise covariance matrix Q is unexpectedly "
            "discarded.")]] inline constexpr auto
kalman<Filter>::q() const -> const process_uncertainty & {
  return filter.q;
}
...
[[nodiscard("The returned process noise covariance matrix Q is unexpectedly "
            "discarded.")]] inline constexpr auto
kalman<Filter>::q() -> process_uncertainty & {
  return filter.q;
}
...
kalman<Filter>::r() const -> const output_uncertainty & {
  return filter.r;
}
...
[[nodiscard("The returned observation noise covariance matrix R is "
            "unexpectedly discarded.")]] inline constexpr auto
kalman<Filter>::r() -> output_uncertainty & {
  return filter.r;
}
...
[[nodiscard("The returned state transition matrix F is unexpectedly "
            "discarded.")]] inline constexpr auto
kalman<Filter>::f() const -> const state_transition & {
  return filter.f;
}
...
[[nodiscard("The returned state transition matrix F is unexpectedly "
            "discarded.")]] inline constexpr auto
kalman<Filter>::f() -> state_transition & {
  return filter.f;
}
