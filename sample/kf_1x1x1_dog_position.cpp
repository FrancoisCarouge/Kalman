...
[[maybe_unused]] auto sample{[] {
  kalman filter{
      // This is the dog's initial position expressed as a Gaussian. The
      // position is 0 meters.
      state{1.},
      // We are predicting that at each time step the dog moves forward one
      // meter. This is the process model - the description of how we think the
      // dog moves. How do I know the velocity? Magic? Consider it a prediction,
      // or perhaps we have a secondary velocity sensor. Please accept this
      ...
      // values fall within of the mean.
      ...
      // variance there is in each measurement.
