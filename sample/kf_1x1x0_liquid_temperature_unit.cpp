...
[[maybe_unused]] auto sample{[] {
  ...
  /*
    ...
    " "deviation is: 0.036°C."); assert(abs(1 - filter.x() / temperature{49.988
    * deg_C}) < 0.001 && "The state estimates expected at 0.1% accuracy." "The
    filter estimates the liquid temperature at 49.988°C."); assert(abs(1 -
