...
//! @brief Specialization of the multiplier type for uncertainty type deduction.
template <auto Reference1, auto Reference2>
struct multiplier<mp_units::quantity_point<Reference1>,
...
//! @brief Specialization of the multiplier type for uncertainty type deduction.
template <auto Reference1, auto Reference2>
struct divider<mp_units::quantity_point<Reference1>,
               mp_units::quantity_point<Reference2>> {
  [[nodiscard]] inline constexpr auto
  operator()(const mp_units::quantity_point<Reference1> &lhs,
             const mp_units::quantity_point<Reference2> &rhs) const ->
...
inline mp_units::quantity_point<Reference>
    identity<mp_units::quantity_point<Reference>>{1. * Reference};

template <auto Reference>
inline mp_units::quantity_point<Reference>
    zero<mp_units::quantity_point<Reference>>{1. * Reference};
