...
[[maybe_unused]] constexpr auto test{[] {
  constexpr matrix<double, 3, 3> m{{1, 2, 3}, {4, 5, 6}, {7, 8, 9}};

  static_assert(m(0, 0) == 1.0);
  static_assert(m(0, 1) == 2.0);
  static_assert(m(0, 2) == 3.0);
  static_assert(m(1, 0) == 4.0);
  static_assert(m(1, 1) == 5.0);
  static_assert(m(1, 2) == 6.0);
  static_assert(m(2, 0) == 7.0);
  static_assert(m(2, 1) == 8.0);
  static_assert(m(2, 2) == 9.0);
